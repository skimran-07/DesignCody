(() => {
        ...
        for (let s = 1; s < arguments.length; s += 1) {
            ...
            if (null != i && !w(i)) {
                ...
                for (let t = 0, n = s.length; t < n; t += 1) {
                    ...
                    void 0 !== a && a.enumerable && (b(e[n]) && b(i[n]) ? i[n].__swiper__ ? e[n] = i[n] : C(e[n], i[n]) : !b(e[n]) && b(i[n]) ? (e[n] = {}, i[n].__swiper__ ? e[n] = i[n] : C(e[n], i[n])) : e[n] = i[n])
                }
            }
        }
        return e
    ...
    const O = {
        ...
        updateSlides: function() {
            ...
            for (let n = 0; n < p; n += 1) {
                ...
                if (x && e.grid.updateSlide(n, r, p, t), "none" !== r.css("display")) {
                    ...
                    c[n] && (c[n].swiperSlideSize = E), f.push(E), i.centeredSlides ? (C = C + E / 2 + T / 2 + w, 0 === T && 0 !== n && (C = C - a / 2 - w), 0 === n && (C = C - a / 2 - w), Math.abs(C) < .001 && (C = 0), i.roundLengths && (C = Math.floor(C)), S % i.slidesPerGroup == 0 && u.push(C), h.push(C)) : (i.roundLengths && (C = Math.floor(C)), (S - Math.min(e.params.slidesPerGroupSkip, S)) % e.params.slidesPerGroup == 0 && u.push(C), h.push(C), C = C + E + w), e.virtualSize += E + w, T = E, S += 1
                }
            }
            ...
            if (p !== d && e.emit("slidesLengthChange"), u.length !== v && (e.params.watchOverflow && e.checkOverflow(), e.emit("snapGridLengthChange")), h.length !== b && e.emit("slidesGridLengthChange"), i.watchSlidesProgress && e.updateSlidesOffset(), !(o || i.cssMode || "slide" !== i.effect && "fade" !== i.effect)) {
        ...
        updateAutoHeight: function(e) {
            ...
            if ("auto" !== t.params.slidesPerView && t.params.slidesPerView > 1)
                if (t.params.centeredSlides)(t.visibleSlides || f([])).each((e => {
                    s.push(e)
                }));
                else
    ...
    const A = {
        ...
        slideToClickedSlide: function() {
            ...
            if (t.loop) {
                ...
                n = parseInt(f(e.clickedSlide).attr("data-swiper-slide-index"), 10), t.centeredSlides ? a < e.loopedSlides - i / 2 || a > e.slides.length - e.loopedSlides + i / 2 ? (e.loopFix(), a = s.children(`.${t.slideClass}[data-swiper-slide-index="${n}"]:not(.${t.slideDuplicateClass})`).eq(0).index(), m((() => {
                    e.slideTo(a)
                }))) : e.slideTo(a) : a > e.slides.length - i ? (e.loopFix(), a = s.children(`.${t.slideClass}[data-swiper-slide-index="${n}"]:not(.${t.slideDuplicateClass})`).eq(0).index(), m((() => {
                    e.slideTo(a)
                }))) : e.slideTo(a)
            } else e.slideTo(a)
        }
    ...
    function D(e) {
        ...
        if (Object.assign(a, {
                ...
                isScrolling: void 0,
                startMoving: void 0
            }), o.startX = m, o.startY = v, a.touchStartTime = g(), t.allowClick = !0, t.updateSize(), t.swipeDirection = void 0, l.threshold > 0 && (a.allowThresholdMove = !1), "touchstart" !== c.type) {
            let e = !0;
    ...
    function G(e) {
        ...
        if (!s.allowTouchMove) return f(d.target).is(i.focusableElements) || (s.allowClick = !1), void(i.isTouched && (Object.assign(r, {
            startX: p,
            startY: u,
            currentX: p,
            currentY: u
    ...
    function B(e) {
        ...
        if (c > i.longSwipesMs) {
            ...
            "next" === t.swipeDirection && (b >= i.longSwipesRatio ? t.slideTo(i.rewind && t.isEnd ? f : u + w) : t.slideTo(u)), "prev" === t.swipeDirection && (b > 1 - i.longSwipesRatio ? t.slideTo(u + w) : null !== v && b < 0 && Math.abs(b) > i.longSwipesRatio ? t.slideTo(v) : t.slideTo(u))
        } else {
            if (!i.shortSwipes) return void t.slideTo(t.activeIndex);
            t.navigation && (o.target === t.navigation.nextEl || o.target === t.navigation.prevEl) ? o.target === t.navigation.nextEl ? t.slideTo(u + w) : t.slideTo(u) : ("next" === t.swipeDirection && t.slideTo(null !== f ? f : u + w), "prev" === t.swipeDirection && t.slideTo(null !== v ? v : u))
        }
    }
    ...
    const V = {
            attachEvents: function() {
                ...
                e.onTouchStart = D.bind(e), e.onTouchMove = G.bind(e), e.onTouchEnd = B.bind(e), s.cssMode && (e.onScroll = j.bind(e)), e.onClick = _.bind(e), i.touch && !F && (t.addEventListener("touchstart", H), F = !0), q(e, "on")
            },
    ...
    class Q {
        constructor() {
            ...
            const a = this;
            a.__swiper__ = !0, a.support = $(), a.device = M({
            ...
            const l = C({}, Y, r);
            return a.params = C({}, l, J, t), a.originalParams = C({}, a.params), a.passedParams = C({}, t), a.params && a.params.on && Object.keys(a.params.on).forEach((e => {
        ...
        mount(e) {
            ...
            if (0 === a.length && t.params.createElements) {
                ...
                a = f(e), e.className = t.params.wrapperClass, s.append(e), s.children(`.${t.params.slideClass}`).each((e => {
                    a.append(e)
                }))
            }
    ...
    function ne(t, s, i) {
        if (document.querySelector(t)) {
            ...
            var n = document.querySelectorAll('[data-role="gallery"]');
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ! function() {
            var e = document.querySelectorAll(".upcoming_filters-filter");
            ne(".upcoming_slider", ".upcoming_nav", {
                spaceBetween: 30,
                observer: !0,
                updateOnImagesReady: !0,
                loop: !1,
            ...
            var t = document.querySelector(".upcoming_slider").swiper,
                s = document.querySelectorAll(".upcoming_slider-slide");
            e.forEach((function(i, n) {
                i.addEventListener("click", (function() {
                    var a = i.dataset.target;
                    s.forEach((function(e) {
                        e.classList.contains(a) ? e.style.display = "" : e.style.display = "none", "all" === a && (e.style.display = "")
                    }));
                    for (var r = 0; r < e.length; r++) r !== n && e[r].classList.remove("current");
                    return i.classList.add("current"), t.updateSize(), t.updateSlides(), t.updateProgress(), t.updateSlidesClasses(), t.slideTo(0), !1
                }))
            }))
        }()
    }))
